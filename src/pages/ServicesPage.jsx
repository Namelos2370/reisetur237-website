...
const SERVICES=[
  ...
  {num:'02',image:'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=700&q=80',title:"Apprentissage des Langues",items:[{title:'Cours de langues',desc:"Formations en langue allemande de A1 à C1, cours intensifs avec préparation aux examens officiels."},{title:'Préparation aux examens',desc:"Sessions d'entraînement pour réussir les tests requis pour les visas ou admissions."}]},
    ...
    <div style={{paddingTop:62,fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:isMobile?'36px 16px':'60px 28px'}}>
              ...
              <div>
                ...
                {svc.num==='02' && (
                  <button
                    ...
                    Voir les niveaux & tarifs <ChevronRight size={13}/>
                  </button>
                )}
              </div>
            </div>
        ...
        <div id="cours-langue" style={{marginTop:isMobile?48:72,scrollMarginTop:80}}>
          ...
          {/* Level cards */}
          <div style={{display:'grid',gridTemplateColumns:isMobile?'1fr':isMobile?'1fr 1fr':'repeat(3,1fr)',gap:isMobile?14:20}}>
          ...
          <div className="reveal" style={{marginTop:28,display:'grid',gridTemplateColumns:isMobile?'repeat(2,1fr)':'repeat(6,1fr)',gap:12}}>
            {[
              ...
              {icon:'🖥️',label:'Salles modernes & équipées'},

...
const SERVICES=[
  {num:'01',image:'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=700&q=80',title:"Orientation et Conseil Academique",items:[{title:'Bilan de profil',desc:"Analyse de votre parcours academique pour evaluer vos chances d'eligibilite a l'etranger."},{title:'Choix des filieres',desc:"Aide a la selection des etablissements et programmes les plus adaptes a vos objectifs."}]},
  {num:'02',image:'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=700&q=80',title:"Apprentissage des Langues",items:[{title:'Cours de langues',desc:"Formations en langue allemande de A1 a C1, cours intensifs avec preparation aux examens officiels."},{title:'Preparation aux examens',desc:"Sessions d'entrainement pour reussir les tests requis pour les visas ou admissions."}]},
  {num:'03',image:'https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=700&q=80',title:"Assistance aux Procedures d'Admission",items:[{title:'Gestion des candidatures',desc:"Constitution et envoi des dossiers d'inscription aupres des universites partenaires."},{title:'Aide a la redaction',desc:"Redaction de lettres de motivation et CV aux normes internationales."}]},
  {num:'04',image:'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=700&q=80',title:"Accompagnement Visa et Procedures Consulaires",items:[{title:'Constitution du dossier visa',desc:"Verification des pieces requises : justificatifs, formulaires consulaires, traductions et apostilles."},{title:"Simulation d'entretiens",desc:"Preparation aux entretiens consulaires pour maximiser vos chances d'obtention du visa."}]},
  {num:'05',image:'https://images.unsplash.com/photo-1560439514-4e9645039924?w=700&q=80',title:"Integration et Suivi post-arrivee",items:[{title:'Logement et accueil',desc:"Conseils pour trouver un logement etudiant ou professionnel avant le depart."},{title:'Demarches administratives',desc:"Orientation pour les premieres etapes a l'arrivee : inscription universitaire, assurance sante, compte bancaire."}]},
]

const LANGUAGE_LEVELS=[
  {level:'A1',label:'Debutant',color:'#4CAF50',duree:'2 mois',prix:'115 000 FCFA',modalite:'Presentiel',horaires:'Lun-Ven 8h-12h ou 15h-17h30',desc:'Bases de la communication : alphabet, salutations, chiffres et formules courantes.'},
  {level:'A2',label:'Elementaire',color:'#8BC34A',duree:'1,5 mois',prix:'115 000 FCFA',modalite:'Presentiel',horaires:'Lun-Ven 8h-12h ou 15h-17h30',desc:'Conversations simples, vie quotidienne, achats et directions.'},
  {level:'B1',label:'Intermediaire',color:GOLD,duree:'1,5 mois',prix:'120 000 FCFA',modalite:'Presentiel',horaires:'Lun-Ven 8h-12h (matin) ou 11h30-15h (apres-midi)',desc:'Communication autonome, grammaire intermediaire, textes courants.'},
  {level:'B2',label:'Avance',color:'#FF9800',duree:'1,5 mois',prix:'125 000 FCFA',modalite:'Presentiel',horaires:'Lun-Ven 11h30-15h',desc:'Niveau requis pour visa Allemagne et Ausbildung Pflege. Argumentation avancee.'},
  {level:'C1',label:'Courant',color:RED,duree:'1,5 mois',prix:'130 000 FCFA',modalite:'Presentiel',horaires:'Sur demande',desc:'Maitrise professionnelle, redaction complexe, discours techniques et academiques.'},
]
  ...
  return(
    ...
    <div style={{paddingTop:62,fontFamily:"'DM Sans',sans-serif"}}>
      ...
      <div style={{background:`linear-gradient(135deg,${NAVY},#1B3E6F)`,padding:isMobile?'48px 16px 40px':'64px 32px 56px',textAlign:'center',position:'relative',overflow:'hidden'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.6)',fontSize:isMobile?15:17}}>Un accompagnement complet, de l'orientation au depart</p>
      </div>
      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:isMobile?'36px 16px':'60px 28px'}}>
        ...
        <div id="cours-langue" style={{marginTop:isMobile?48:72,scrollMarginTop:80}}>
          ...
          <div className="reveal" style={{textAlign:'center',marginBottom:36}}>
            ...
            <p style={{color:'#64748B',fontSize:15,maxWidth:580,margin:'0 auto'}}>
              Cours intensifs du niveau A1 au C1 — Yaounde, Essos, Avenue Germaine.<br/>
            ...
            <div style={{marginTop:14,display:'inline-block',background:'#FFF3CD',border:'1px solid #FFCC00',borderRadius:8,padding:'7px 18px',fontSize:13,color:'#856404',fontWeight:600}}>
              Frais d'inscription promotionnels : 5 000 FCFA — valable jusqu'a fin septembre 2026
            </div>
          </div>
                ...
                <div style={{padding:'16px 20px 20px'}}>
                  ...
                  <div style={{display:'flex',flexDirection:'column',gap:9}}>
                    <div style={{display:'flex',alignItems:'flex-start',gap:8,fontSize:13}}>
                      <span>&#9201;</span>
                      <span style={{color:'#64748B'}}><strong style={{color:NAVY}}>Duree :</strong> {lvl.duree}</span>
                    </div>
                    <div style={{display:'flex',alignItems:'flex-start',gap:8,fontSize:13}}>
                      <span>&#128336;</span>
                    ...
                    <div style={{display:'flex',alignItems:'flex-start',gap:8,fontSize:13}}>
                      <span>&#128205;</span>
                      <span style={{color:'#64748B'}}><strong style={{color:NAVY}}>Modalite :</strong> {lvl.modalite}</span>
                    </div>
                  </div>
                  <a
                    href={"https://wa.me/237620107489?text=Bonjour%2C%20je%20souhaite%20m%27inscrire%20au%20cours%20d%27allemand%20niveau%20" + lvl.level}
                    target="_blank"
          ...
          <div className="reveal" style={{marginTop:28,display:'grid',gridTemplateColumns:isMobile?'repeat(2,1fr)':'repeat(6,1fr)',gap:12}}>
            {[
              ...
              {icon:'🖥️',label:'Salles modernes et equipees'},
              {icon:'📚',label:'Materiel de cours offert'},
              {icon:'📶',label:'Wi-Fi haut debit'},
              {icon:'🎯',label:'Preparation intensive aux examens'},
              {icon:'✈️',label:'Accompagnement vers le reve allemand'},
            ].map((a,i)=>(
          ...
          <div className="reveal" style={{marginTop:28,background:`linear-gradient(135deg,${NAVY},#1B3E6F)`,borderRadius:16,padding:isMobile?'24px 16px':'36px 40px',textAlign:'center',border:`1px solid ${GOLD}44`}}>
            ...
            <h3 style={{fontFamily:"'Playfair Display',serif",fontSize:isMobile?20:26,color:'#fff',marginBottom:10}}>
              Parcours complet A1 vers C1 en <span style={{color:GOLD}}>8 mois</span>
            </h3>
            <p style={{color:'rgba(255,255,255,0.6)',fontSize:14,marginBottom:20}}>
              Paiement echelonne disponible — Samedi reserve aux evaluations — Yaounde, Essos
            </p>
            <a href="https://wa.me/237620107489?text=Bonjour%2C%20je%20souhaite%20m%27inscrire%20aux%20cours%20d%27allemand%20Reisetur%20237"
        ...
        <div className="reveal" style={{marginTop:40,background:`linear-gradient(135deg,${NAVY},${RED})`,borderRadius:16,padding:isMobile?'28px 16px':'40px',textAlign:'center'}}>
          <p style={{color:'rgba(255,255,255,0.65)',fontSize:15,marginBottom:18}}>Pret a concretiser votre projet a l'etranger ?</p>
          <Link to="/contact" style={{display:'inline-flex',alignItems:'center',gap:8,background:GOLD,color:NAVY,textDecoration:'none',borderRadius:11,padding:'13px 28px',fontSize:14.5,fontWeight:700}}>
            Deposer ma candidature <ChevronRight size={15}/>
          </Link>
        </div>
